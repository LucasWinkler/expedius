...
const destinations: Destination[] = [
  ...
  },
  {
    ...
    rotation: -2.5,
    initialPosition: {
      desktop: { top: "18%", left: "14%" },
      tablet: { top: "18%", left: "10%" },
      largeDesktop: { top: "18%", left: "18%" },
    },
    size: {
  ...
  },
  {
    ...
    rotation: 2,
    initialPosition: {
      desktop: { top: "60%", right: "14%" },
      tablet: { top: "62%", right: "9%" },
      largeDesktop: { top: "60%", right: "18%" },
    },
    size: {
