...
export const HomeHero = () => {
  return (
    <section className="relative bg-gradient-to-b from-background via-background/95 to-muted pb-20 pt-12 sm:pb-32 sm:pt-24 2xl:pb-40 2xl:pt-32">
      ...
      <div className="container relative z-20 mx-auto px-4">
        <header className="mx-auto max-w-4xl rounded-3xl p-6 text-center 2xl:max-w-5xl">
          ...
          <p className="mx-auto mt-4 max-w-[35ch] text-base text-muted-foreground sm:mt-5 sm:text-lg md:text-xl 2xl:mt-6 2xl:text-2xl">
