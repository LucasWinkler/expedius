...
export const DeleteAccount = ({ url, name }: DeleteAccountProps) => {
  const previewText = `Confirm account deletion request for Expedius`;
          ...
          <Container className="mx-auto my-0 max-w-[600px] px-0 py-12">
            ...
            <Section className="my-4 rounded-lg bg-white p-8 shadow-sm">
              ...
              <Text className="my-4 text-base leading-6 text-muted-foreground">
                Hello {name}, we received a request to delete your account.
              </Text>
              <Text className="my-4 text-base leading-6 text-muted-foreground">
                This action is permanent and cannot be undone. All your data,
                including your profile, lists, and saved places will be
                permanently removed.
              </Text>
              <Text className="my-4 text-base leading-6 text-muted-foreground">
                Please click the button below to confirm this deletion.
              </Text>
              <Button
                href={url}
                className="mb-4 mt-6 block w-full rounded-md bg-destructive px-5 py-3 text-center text-base font-bold text-destructive-foreground no-underline"
              >
                Confirm Account Deletion
              </Button>
              <Text className="my-4 text-base leading-6 text-muted-foreground">
                If the button doesn&apos;t work, you can also confirm by
                clicking this link:
              </Text>
              <Text className="my-4 text-base leading-6 text-muted-foreground">
              ...
              <Text className="my-4 text-base leading-6 text-muted-foreground">
                This confirmation link will expire in 24 hours. If you did not
                request this action, you can safely ignore this email.
              </Text>
            </Section>
