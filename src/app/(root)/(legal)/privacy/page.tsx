      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <ul className="ml-6 list-disc space-y-2 text-muted-foreground">
            ...
            <li>
              <p>
                <span className="font-medium text-foreground">Cookies</span> are
            ...
            <li>
              <p>
                ...
                refers to Expedius, accessible from{" "}
                <a
                  href="https://www.expedius.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="text-primary underline underline-offset-4 transition-colors hover:text-primary/80"
                >
                  https://www.expedius.app/
                </a>
              </p>
            </li>
            <li>
              <p>
                <span className="font-medium text-foreground">You</span> means
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3">
            ...
            <ul className="ml-6 space-y-4 text-muted-foreground">
              <li>
                <span className="font-medium text-foreground">
